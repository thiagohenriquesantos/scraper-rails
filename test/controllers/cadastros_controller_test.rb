...
class CadastrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cadastro" do
    assert_difference('Cadastro.count') do
      post cadastros_url, params: { cadastro: { nome: @cadastro.nome, url_twitter: @cadastro.url_twitter } }
    end
  ...
  test "should update cadastro" do
    patch cadastro_url(@cadastro), params: { cadastro: { nome: @cadastro.nome, url_twitter: @cadastro.url_twitter } }
